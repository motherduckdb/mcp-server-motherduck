...
| `--motherduck-connection-parameters` | `session_hint=mcp&`<wbr>`dbinstance_inactivity_ttl=0s` | Additional MotherDuck connection string parameters (`key=value` pairs separated by `&`) |
